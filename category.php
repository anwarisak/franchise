        ...
        <div class="col-sm-12">
          <div class="card">
            <div class="text-end">
              ...
              <button type="button" class="btn btn-outline-primary  m-2" id="categorybutton" data-bs-toggle="modal" data-bs-target="#categorymodal">
                Add paymnet
              </button>
            </div>
            <table class="table table-striped table-borderless table-sm" id="categorytable">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <!-- form user -->
          <form id="categoryform" enctype="multi-part/form-data">
