        ...
        <div class="col-sm-12">
          <div class="card">
            <div class="text-end">
              ...
              <button type="button" class="btn btn-outline-primary  m-2" id="contactbtn" data-bs-toggle="modal" data-bs-target="#contactmodal">
                Add Contact
              </button>
            </div>
            <table class="table table-striped table-borderless table-sm" id="contactable">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <!-- form user -->
          <form id="contactform" enctype="multi-part/form-data">
            ...
            <div class="container">
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="">franchiser </label>
                    <input type="text" class="form-control" id="franchiser" name="franchiser" placeholder="franchiser">
                  </div>
                </div>
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="">comission_fee </label>
                    <input type="number" class="form-control" id="comission_fee" name="comission_fee" placeholder="comission_fee">
                  </div>
                </div>
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="">contract_expire </label>
                    <input type="date" class="form-control" id="contract_expire" name="contract_expire">
                  </div>
                </div>
