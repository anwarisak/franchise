...
<div class="container-scroller">
        ...
        <div class="col-sm-12">
          <div class="card">
            <div class="text-end">
              ...
              <button type="button" class="btn btn-outline-primary  m-2" id="payment_methodbutton" data-bs-toggle="modal" data-bs-target="#payment_methodmodal">
                Add payment_method
              </button>
            </div>
            <table class="table table-striped table-borderless table-sm" id="payment_methodtable">
  ...
  <!-- usermodel -->
  <div class="modal" tabindex="-1" role="dialog" id="payment_methodmodal">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">add payment_method</h5>
        ...
        <div class="modal-body">
          <!-- form user -->
          <form id="payment_methodForm" enctype="multi-part/form-data">
              ...
              <div class="row">
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    <label for="">payment_method_name </label>
                    <input type="text" class="form-control" id="method_name" name="method_name" placeholder="payment_method_name">
                  </div>
                </div>
