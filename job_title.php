...
<div class="container-scroller">
        ...
        <div class="col-sm-12">
          <div class="card">
            <div class="text-end">
              ...
              <button type="button" class="btn btn-outline-primary  m-2" id="job_titlebutton" data-bs-toggle="modal" data-bs-target="#job_titleymodal">
                Add job title
              </button>
            </div>
            <table class="table table-striped table-borderless table-sm" id="job_titletable">
  ...
  <!-- usermodel -->
  <div class="modal" tabindex="-1" role="dialog" id="job_titleymodal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <!-- form user -->
          <form id="job_titleform" enctype="multi-part/form-data">
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="job_title_name" name="job_title_name" placeholder="job_title_name">
                  </div>
                </div>
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="job_title_salary" name="job_title_salary" placeholder="salary">
                  </div>
                </div>
